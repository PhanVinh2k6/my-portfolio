...
export const metadata: Metadata = {
  ...
  description: 'Signal Room là game hub offline-first với daily puzzle Wend và Zip, Hint, timer, local leaderboard cùng năm trò chơi replay.',
