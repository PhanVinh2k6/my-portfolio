...
export default function Home() {
  ...
  return <main id="main-content" className="new-site-shell"><a className="skip-link" href="#work">Skip to content</a>
    ...
    <section id="play" data-home-section className="new-section new-play"><div className="new-index">05 <span>Signal Room</span></div><div className="play-teaser"><div className="play-teaser-copy"><p className="new-eyebrow">Offline-first / Small games</p><h2>A little room<br />for <em>play.</em></h2><p>Seven small games built as a reminder that interfaces can be useful and delightful at the same time. Wend and Zip refresh daily; the rest are ready for replay. No account, no signal required.</p><Link className="new-button new-button-light" href="/play">Open the arcade <ArrowUpRight size={17} /></Link></div><div className="play-teaser-art"><Image src="/arcade-keyvisual.webp" alt="Arcade machine visual for Signal Room" fill sizes="(max-width: 800px) 100vw, 50vw" /><span>PV-26 / INSERT FUN</span></div></div></section>
